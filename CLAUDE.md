...
- `UPGRADE_INTERVAL_SECS` (default: 86400 = daily; `0` disables) — how often to run the quality-upgrade + full-season consolidation pass. On by default; set to `0` to disable entirely.
